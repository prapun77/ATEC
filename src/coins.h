...
/** 
    ...
    ****Note - for ATEC we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of atec coming in to a transaction
