...
#ifndef ATEC_ZATCWALLET_H
#define ATEC_ZATCWALLET_H
...
public:
    CzATCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZATC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZATC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //ATEC_ZATCWALLET_H
