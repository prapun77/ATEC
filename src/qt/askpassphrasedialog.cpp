                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zATC || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending ATC because you wouldn't check it anyway.
    if (context == Context::Send_ATC || context == Context::Send_zATC) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("ATEC will close now to finish the encryption process. "
