                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ATEC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zATC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ATEC Core"), this);
    aboutAction->setStatusTip(tr("Show information about ATEC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ATEC"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ATEC Core help message to get a list with possible ATEC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ATEC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ATEC network", "", count));
}
...
{
    QString strTitle = tr("ATEC Core"); // default title
