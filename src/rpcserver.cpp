...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ATEC features */
        {"atec", "masternode", &masternode, true, true, false},
        {"atec", "listmasternodes", &listmasternodes, true, true, false},
        {"atec", "getmasternodecount", &getmasternodecount, true, true, false},
        {"atec", "masternodeconnect", &masternodeconnect, true, true, false},
        {"atec", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"atec", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"atec", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"atec", "masternodecurrent", &masternodecurrent, true, true, false},
        {"atec", "masternodedebug", &masternodedebug, true, true, false},
        {"atec", "startmasternode", &startmasternode, true, true, false},
        {"atec", "createmasternodekey", &createmasternodekey, true, true, false},
        {"atec", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"atec", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"atec", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"atec", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"atec", "getmasternodescores", &getmasternodescores, true, true, false},
        {"atec", "mnbudget", &mnbudget, true, true, false},
        {"atec", "preparebudget", &preparebudget, true, true, false},
        {"atec", "submitbudget", &submitbudget, true, true, false},
        {"atec", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"atec", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"atec", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"atec", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"atec", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"atec", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"atec", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"atec", "checkbudgets", &checkbudgets, true, true, false},
        {"atec", "mnsync", &mnsync, true, true, false},
        {"atec", "spork", &spork, true, true, false},
        {"atec", "getpoolinfo", &getpoolinfo, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42473/\n";
}
