...
#ifndef ATEC_STAKEINPUT_H
#define ATEC_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZATC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zATCStake can take two forms
...
public:
    ...
    bool IsZATC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZATC() override { return false; }
};


#endif //ATEC_STAKEINPUT_H
