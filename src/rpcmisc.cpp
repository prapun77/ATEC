...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total atec balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zATCsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zATC denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zATC denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zATC denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zATC denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zATC denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zATC denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zATC denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zATC denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zATC denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in atec/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in atec/kb\n"
    ...
    obj.push_back(Pair("zATCsupply", zpivObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"atecaddress\"\n"
            "\nReturn information about the given atec address.\n"

            "\nArguments:\n"
            "1. \"atecaddress\"     (string, required) The atec address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"atecaddress\", (string) The atec address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: ATEC address and we have full public key:
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"atecaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"atecaddress\"  (string, required) The atec address to use for the signature.\n"
