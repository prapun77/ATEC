...
*Setup instructions for a gitian build of ATEC using a Debian VM or physical system.*
...
Clone the git repositories for atec and gitian and then checkout the atec version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/atec-crypto/atec.git
cd atec
...
Follow the instructions in [doc/release-process.md](release-process.md) in the atec repository
...
To build ATEC (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the atec repository.
...
```bash
    ...
    From https://github.com/atec-crypto/atec
...
For example:
```bash
URL=https://github.com/crowning-/atec.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/atec-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/atec-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/atec-build.assert
```
...
[atec/gitian.sigs](https://github.com/atec-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
