...
In order to support loading of multiple wallets in atec-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is atec.cpp.
...
Changes to atec.cpp
----------------------
atec.cpp is the entry point into atec-qt, and as such, will require some minor modifications to provide hooks for
