Contributing to ATEC Core
============================

The ATEC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ATEC Core project, and is not to be
confused with overall ATEC Network Protocol consensus changes.

Whether a pull request is merged into ATEC Core rests with the project merge
...
Patches that change ATEC consensus rules are considerably more involved than
...
Where a patch set proposes to change the ATEC consensus, it must have been
...
The project leader is the release manager for each ATEC Core release.
