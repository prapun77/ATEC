...
RESOURCES += src/qt/atec.qrc src/qt/atec_locale.qrc

TRANSLATIONS += src/qt/locale/atec_bg.ts \
                src/qt/locale/atec_de.ts \
                src/qt/locale/atec_en.ts \
                src/qt/locale/atec_es.ts \
                src/qt/locale/atec_fi.ts \
                src/qt/locale/atec_fr.ts \
                src/qt/locale/atec_it.ts \
                src/qt/locale/atec_ja.ts \
                src/qt/locale/atec_pl.ts \
                src/qt/locale/atec_pt.ts \
                src/qt/locale/atec_ru.ts \
                src/qt/locale/atec_sk.ts \
                src/qt/locale/atec_sv.ts \
                src/qt/locale/atec_vi.ts \
                src/qt/locale/atec_zh_CN.ts \
                src/qt/locale/atec_zh_TW.ts
